...
namespace TENSORRT_WRAPPER
{
    ...
    class ElementWiseNodeCreator : public NodeCreator
    {
    public:
    ...
    void registerElementWiseNodeCreator()
    {
        insertNodeCreator("ElementWise", new ElementWiseNodeCreator);
    }

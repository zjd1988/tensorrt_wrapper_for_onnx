...
namespace TENSORRT_WRAPPER
{
    ...
    bool ShuffleNodeInfo::parseNodeAttributesFromJson(const Json::Value& root)
    {
    ...
    class ShuffleNodeInfoCreator : public NodeInfoCreator
    {
    public:
        virtual NodeInfo* onCreate(const std::string sub_type, const Json::Value& root) const override 
        {
            std::unique_ptr<NodeInfo> node_info(new ShuffleNodeInfo());
    ...
    void registerShuffleNodeInfoCreator()
    {
        insertNodeInfoCreator("Shuffle", new ShuffleNodeInfoCreator);
        return;
    }
